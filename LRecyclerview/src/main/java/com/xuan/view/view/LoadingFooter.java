...
import com.xuan.view.progressindicator.AVLoadingIndicatorView;
import com.xuan.view.recyclerview.ProgressStyle;
...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter {
    ...
    private int hintColor = R.color.colorGray;
