...
//        mDataObserver.onChanged();
    ...
    public void refreshCompleteDelayed(final int pageSize, int delayed) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                LRecyclerView.this.mPageSize = pageSize;
    ...
    public void setHeaderBottomMargin(int bottomMargin){
        if (mRefreshHeader != null && mRefreshHeader instanceof ArrowRefreshHeader) {
            ArrowRefreshHeader arrowRefreshHeader = ((ArrowRefreshHeader) mRefreshHeader);
            LinearLayout.LayoutParams params= (LinearLayout.LayoutParams) arrowRefreshHeader.getLayoutParams();
