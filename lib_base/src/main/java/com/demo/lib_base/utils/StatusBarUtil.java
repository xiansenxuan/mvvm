...
public class StatusBarUtil {
    ...
    public static void tintStatusBar(Window window,
        ...
        if (rootView != null) {
            ViewCompat.getFitsSystemWindows(rootView);
        }
    ...
    public static boolean isMIUI6Later() {
        ...
        try {
            ...
            String val = (String) mtd.invoke(null, "ro.miui.ui.version.workerName");
    ...
    public static void setSystemBarBg(AppCompatActivity activity, int colors){
        Window window = activity.getWindow();
        ...
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            window.setStatusBarColor(ContextCompat.getColor(activity,colors));
        }
